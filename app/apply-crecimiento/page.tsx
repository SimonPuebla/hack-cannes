        ...
        <Card className="w-full bg-[#ffffffee] backdrop-blur-sm border-white/20">
          <CardContent className="p-8">
            <div className="text-center space-y-2 mb-6">
              <h1 className="text-2xl font-bold font-serif">Apply to Crecimiento</h1>
              <p className="text-[#2e2a4d]/70">Join the growth-focused community</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="reason"
                  placeholder="Tell us about your interest in joining Crecimiento..."
                  value={reason}
